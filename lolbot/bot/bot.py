...
class Bot:
    ...
    def set_game_config(self) -> None:
        ...
        itemSetsConfig = os.path.join(config_dir, 'ItemSets.json')
        ...
        if self.config.champ == 10:
            ...
            eq_config = '{"accountId":17431991082,"itemSets":[{"associatedChampions":[],"associatedMaps":[11,12],"blocks":[{"hideIfSummonerSpell":"","items":[{"count":1,"id":"3047"},{"count":1,"id":"3075"},{"count":1,"id":"6665"},{"count":1,"id":"2504"},{"count":1,"id":"3068"},{"count":1,"id":"3143"}],"showIfSummonerSpell":"","type":"new"}],"map":"any","mode":"any","preferredItemSlots":[],"sortrank":0,"startedFrom":"blank","title":"malphite","type":"custom","uid":"4d7dc320-1860-11f0-acd8-cdfc9c909c19"}],"timestamp":0}'
        ...
        with open(itemSetsConfig, "w") as itemSetsConfigFile:
            itemSetsConfigFile.write(eq_config)
